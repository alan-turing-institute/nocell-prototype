...
(module+ test
  ...
  (test-case "unwinding a map"
             (check-stack '((map (lambda (a) (+ 1 a)) (1 2 3))) '((0 a ((col 0 (1 2 3)) (col 1 (1 2 3)) (col 2 (1 2 3))) ())
                                                                  (1 "" ((+ 1 (col 0 (row 0))) (+ 1 (col 1 (row 0))) (+ 1 (col 2 (row 0)))) ())
  ...
  (test-case "unwinding a foldl"
             (check-stack '((foldl (lambda (x accumulator) (+ accumulator x)) 5 (1 2 3))) '(
                                                                                            (0 x ((col 0 (1 2 3)) (col 1 (1 2 3)) (col 2 (1 2 3))) ())
                                                                                            (1 accumulator (5 (col 0 (row 2)) (col 1 (row 2))) ()) 
                                                                                            (2 "" (
             ...
             (define dcf-expected  
               '((0 years (2020 2021 2022 2023) ())
                 ...
                 (19
                  ...
                  ())
                 (20 total (+ (col 3 (row 19)) (row 16)) (return))
                 (21 dcf-value (row 20) (return))
